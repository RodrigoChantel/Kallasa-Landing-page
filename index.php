        ...
        <nav class="navbar navbar-expand-lg  position-fixed bg-light py-3 border-bottom" style="width: 100%; z-index:900;">
            ...
            <a class="navbar-brand text-dark fw-bold" href="#"><i class="fa-sharp fa-solid fa-rocket"></i> Kallasa.Mkt</a>
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                    <i class="fa-sharp fa-solid fa-bars text-dark"></i>
                </button>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mx-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown mx-2">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#">Identidade Visual</a></li>
                                <li><a class="dropdown-item" href="#">Sites e Sistemas</a></li>
                    ...
                    <div class="center-ctn">
                        <button class="btn-ctn">
                            <svg width="150px" height="40px" viewBox="0 0 150 40" class="border-ctn">
                            <polyline points="179,1 179,59 1,59 1,1 179,1" class="bg-line" />
                            <polyline points="179,1 179,59 1,59 1,1 179,1" class="hl-line" />
                            </svg>
                            <span><i class="fa-sharp fa-solid fa-headset"></i>&nbsp;&nbsp;CONTATO</span>
                        </button>
                    </div>
                </div>
            </div>
        ...
        <section class="section-01 w-100 bg-light d-flex flex-row flex-nowrap justify-content-center" style="height: 800px;">
            <div class="container-lg h-100 d-flex flex-row flex-wrap justify-content-between align-items-center">
                ...
                <div class="container-fluid mx-md-0 mx-auto px-0 asd" style="width: 400px;">
                    <h5 class="card-title fs-1 text-white">Você não precisa dar conta de tudo!</h5><br>
                    <p class="card-text fs-5 text-light">Nós estamos aqui para facilitar a sua vida e fazer a sua empresa voar.</p><br>
                    <div class="container-fluid d-flex flex-row flex-wrap justify-content-between px-0">
                        ...
                        <a class="btn btn-light px-5 py-2" href="#">Planos</a>
                    </div>
                </div>
